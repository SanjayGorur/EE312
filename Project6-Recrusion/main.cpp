...
int main(void) {
	...
	printf("\nReal tests for min function\n");
	int b[] = { 5, 7, 2, 1, 18, 2, 40, 4, 4 };
	...
	//printf("the sqrt of 2 is %g\n", sqrtRec(2.0, 0, 2.0));
	printf("the sqrt of 2 is %.16f\n", sqrtRec(2.0, 0, 2.0));
	printf("the sqrt of 127 is %.16f\n", sqrtRec(127.0, 0, 127.0));
	printf("the sqrt of 127 is %.16f\n", sqrtRec(1270.0, 0, 1270.0));
	printf("the sqrt of 153452 is %.16f\n", sqrtRec(153452.0, 0, 153452.0));
	...
	makeMaze();
	recodeMaze();
	printf("\nrecursive solution to the maze\n");
	...
	*/
	...
	//Martian change5 = change(72);
	//printf("change 5 should be 6d, 0n, 0p and is: %dd %dn %dp\n", change5.dodeks, change5.nicks, change5.pennies);

	Martian change6 = change(12);
	printf("change 6 should be 1d, 0n, 0p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	//Martian change7 = change(57);
	//printf("change 7 should be 3d, 4n, 1p and is: %dd %dn %dp\n", change7.dodeks, change7.nicks, change7.pennies);
